        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          >
            <svg
              ...
              className="lucide lucide-arrow-left w-6 h-6 text-[#222222]"
            >
              <path d="m12 19-7-7 7-7" />
              <path d="M19 12H5" />
            </svg>
          </Link>
          <h2 className="text-xl md:text-3xl font-semibold text-[#222222]">
            Langues et devise
          </h2>
        </div>
        ...
        {activeTab === 'currency' && (
          <div>
            <p className="text-sm text-gray-600 mb-4">
              Devise préférée : <strong id="currency-label">{currencyLabel}</strong>
            </p>
